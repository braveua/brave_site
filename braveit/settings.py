"""
Django settings for braveit project.
...
SECRET_KEY = "django-insecure-_6!sv4)@s+bw16m#6ysnevx@el)eq0@p+=qte_v^)&lmz@*+0t"
...
WSGI_APPLICATION = "braveit.wsgi.application"
